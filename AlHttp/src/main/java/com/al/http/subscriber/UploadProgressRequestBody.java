...
public class UploadProgressRequestBody extends RequestBody {
    ...
    protected UploadProgressImpl progressCallBack;

    protected CountingSink countingSink;

    public UploadProgressRequestBody(UploadProgressImpl listener) {
        this.progressCallBack = listener;
    }

    public UploadProgressRequestBody(RequestBody delegate, UploadProgressImpl progressCallBack) {
    ...
    protected final class CountingSink extends ForwardingSink {
        ...
        public void write(Buffer source, long byteCount) throws IOException {
           ...
           Log.e("bytesWritten=" + bytesWritten , "totalBytesCount=" + contentLength);
        }
    }
